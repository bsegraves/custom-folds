...
module.exports = {
	...
	_addClickEvent() {
		...
		foldIcon = editorView.shadowRoot.querySelectorAll('.gutter .line-number.custom-folds-start .icon-right')

		$(foldIcon).on('click', function(e) {
			row = e.target.parentElement.dataset.bufferRow;
